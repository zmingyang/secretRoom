...
inputBoardProperty::inputBoardProperty(inputIOBoard *ioBoard):
...
inputBoardProperty::~inputBoardProperty()
{
...
void inputBoardProperty::on_OKPushButton_clicked()
{
...
void inputBoardProperty::on_CancelPushButton_clicked()
{
    close();
}
